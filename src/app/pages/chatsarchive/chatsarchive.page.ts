  ...
  async ngOnInit() {
    ...
    await this.activaterouter.params.subscribe(async (params:any) => {
      ...
      if(params['chatSessionIdAr']!="" && params['chatSessionIdAr']!=null && params['chatSessionIdAr']!=undefined && params['chatSessionIdAr']!=0){
       ...
       if(params['userNameThisConv']!="" && params['userNameThisConv']!=null && params['userNameThisConv']!=undefined && params['userNameThisConv']!=0){
         let userName = params['userNameThisConv'].toLowerCase();
...
scrollToBottom() {
  ...
  functionArchive(number:any,chatSessionId:any){
    this.navCtrl.navigateRoot(['/archive', {number:number,name:this.selectNumberName,chatSessionId:chatSessionId}]);
  }
