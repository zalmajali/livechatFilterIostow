...
@NgModule({
  ...
  declarations: [AppComponent,PopovercontentComponent,VersionComponent,FastresponseComponent,SubmenuComponent,TemplateComponent,FilterComponent,DatepickerComponent],
  ...
  providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy },VideoEditor,Globalization,Camera,AppVersion,FirebaseMessaging,Network,Chooser,Device,FileTransfer,FilePath,AndroidPermissions,StatusBar,SQLite,File],
